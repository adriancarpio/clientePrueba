 ...
 * generated in the com.prueba.controler package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://controler.prueba.com/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://controler.prueba.com/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.prueba.controler
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controler.prueba.com/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controler.prueba.com/", name = "operationResponse")
